                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ route('dashboard.pengurus.prokers.show', $proker->id) }}" class="btn btn-sm btn-primary mr-1">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('dashboard.pengurus.prokers.edit', $proker->id) }}" class="btn btn-sm btn-warning">
                                    ...
                                    <td>
                                        @if ($proker->logo)
                                            <div class="img-wrapper img-wrapper-table"><img src="{{ 'storage/'.$proker->logo }}" alt=""></div>
                                        @else
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="img-fit img-fit-contain h-12rem h-md-18rem h-lg-24rem">
                    <img src="{{ asset('img/illustration/empty-proker.svg') }}" alt="Dashboard Pengurus Illustration" class="img-fluid">
                </div>
