    ...
    <div class="row gutters-xs align-items-center justify-content-end my-4">
        ...
        <div class="col col-md-auto">
            @if (Request::get('tabs') === 'users')
                <a href="{{ route('dashboard.pengurus.prokers.edit', $proker->id) . '?tabs=users' }}" class="btn btn-warning">
                    <i class="fas fa-pen mr-1"></i> Edit Data
                </a>
            @else
                <a href="{{ route('dashboard.pengurus.prokers.edit', $proker->id) }}" class="btn btn-warning">
                    <i class="fas fa-pen mr-1"></i> Edit Data
                </a>
            @endif
        </div>
