    ...
    <div class="card">
        <div class="card-body">
            <div class="row gutters-xs align-items-center border-bottom pb-3 mb-3">
                ...
                <div class="col-md-auto">
                    <a
                        href="{{ route('dashboard.admin.prokers.index').'?status=1' }}"
                ...
                <div class="col-md-auto">
                    <a
                        href="{{ route('dashboard.admin.prokers.index').'?status=0' }}"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea
                                ...
                                cols="30"
                                rows="8">{{ old('description') ? old('description') : '' }}</textarea>
                            @error('description')
            ...
            */
            ...
            const table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'is_registration_open', name: 'is_registration_open', searchable: false},
                    {data: 'leader', name: 'leader', searchable: false},
                    {data: 'link_registration', name: 'link_registration', searchable: false},
