                                ...
                                <tr>
                                    <td align="center" class="center-text">
                                        <img style="width:190px;border:0px;display: inline!important;"
                                            src="{{ asset('assets/img/emails/Email-2_Intro.png') }}" width="190"
                                            border="0" alt="intro">
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0" role="presentation"
                                            ...
                                            <tr>
                                                ...
                                                <![endif]-->
                                                    ...
                                                    <a target="_blank"
                                                        style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:16px;line-height:19px;font-weight:700;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;padding: 20px 50px 20px 50px;display: inline-block;"><span>{{ __('pleb.mail.Verify Action Button') }}</span></a>
                            ...
                            <table border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td class="center-text" align="center"
                                        ...
                                        - <a href="{{ url('/') }}"
                                            style="color:#6e6e6e;"><span>{{ config('app.name') }}</span></a>
